...
\begin{center}
  \includegraphics[width=0.53\linewidth]{playbook-turn-4-map.pdf}
\end{center}
...
identified side \rulesref{9.41}.

\textbf{Axis reinforcements.} Transfer German 113. Deploy the five regular and
five mountain Croat brigades: six in Bosnia and four in Croatia. The brigade
trigger also releases Bulgarian 25 and 27; place them in Bulgarian Occupation
objectives in Serbia \rulesref{13.91D}.
...
During the Axis Movement Phase, German 342 moves from Serbia into Croatia.
This would have been prohibited before the first-brigade trigger; German units
may now enter the Italian sphere \rulesref{6.64A}.

\phase{E. Terminal Stage}

Recruitment at Novi Pazar, Tuzla, and Cetinje produces one group apiece after
\die{2}, \die{2}, and \die{2}. Tito produces three groups in Croatia.
