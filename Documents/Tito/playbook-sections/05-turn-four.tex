...
\begin{itemize}[leftmargin=1.2em,itemsep=1.5pt]
  ...
  \item Two Croat brigades attack the Hide-away: 4 SP against doubled defense
    ...
    Two groups are lost and the survivor retreats to the Croatia Partisan
    Hide-away.
\end{itemize}
...
Serbia~\mapbadge{4} and moves to the Axis box at Knin in
Croatia~\mapbadge{2}. This would have been prohibited before the first-brigade
trigger; German units may now enter the Italian sphere \rulesref{6.64A}.
