...
\begin{minipage}[t]{0.48\linewidth}
  ...
  \mapcaption{Serbia: AGO deployment and reaction west}
\end{minipage}
\hfill
\begin{minipage}[t]{0.48\linewidth}
  \centering
...
Place German 113 at Zenica (Bosnia) and the 4th and 5th Ustaša brigades at
Bihać (Croatia). Transfer German 125 from Tuzla as scheduled
\rulesref{13.91}.
...
\playbookbreak
\turncontinuation{From Groups to Brigades}
...
Move Tito and three Bosnia groups from the Hide-away to the Partisan Mountain,
and move the fourth group directly to Tuzla. Keep the five-group stack at Novi
Pazar and the five groups in the Slovenia Mountain. Move the lone Montenegro
group back to Cetinje.
...
\begin{tabularx}{\linewidth}{@{}Xr@{}}
  ...
  Source & Groups \\
  \midrule
  Novi Pazar: \dr{6} $\times$ one-half, cap 5 & 3 \\
  Slovenia Mountain: $5 \div 4$ & 1 \\
  Tuzla: \dr{6} $\times$ one-half, cap 1 & 1 \\
  Cetinje: \dr{4} $\times$ one-half, cap 1 & 1 \\
  Tito in Bosnia & 2 \\
  \midrule
...
Place all four in the Croatia Partisan Hide-away.
...
Redeploy German 704 at Belgrade, 714 at Pančevo, 717 at Niš, and 342 at
Kragujevac. The first-brigade trigger is now permanent even if Partisan
strength later falls below 30 group equivalents.
