...
\begin{minipage}[t]{0.52\linewidth}
  \centering
  \includegraphics[height=2.10in,width=\linewidth,keepaspectratio]
    {playbook-turn-2-map.pdf}
...
\begin{minipage}[t]{0.21\linewidth}
  ...
  \includegraphics[width=\linewidth]
    {playbook-turn-2-slovenia-map.pdf}
  \mapcaption{Slovenia}
\end{minipage}
\hfill
\begin{minipage}[t]{0.21\linewidth}
...
At the beginning of Movement, deploy ten Partisan groups and unidentified Tito
in the Serbia Partisan Hide-away, four groups in Slovenia, and three in
Montenegro \rulesref{13.92}.

Because Game-Turn 2 still has the starting-Zone restriction:

\begin{itemize}[leftmargin=1.2em,itemsep=1.5pt]
  \item Serbia: three groups to Užice, three to Novi Pazar, and four plus Tito
    to the Partisan Mountain.
  \item Slovenia: all four groups to the Partisan Mountain.
  \item Montenegro: all three groups to Cetinje.
\end{itemize}
...
German 704 attacks the three groups in Užice. At 12:3 the ratio is 4:1; a
\die{3} produces D1, doubled to D2 for the town. Two groups are removed and
one retreats to the Serbia Partisan Hide-away.
