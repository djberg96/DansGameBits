...
\begin{tabular}{@{}c@{\hspace{1em}}c@{}}
  \counterimage[0.29\linewidth]{german-infantry-front} &
  \counterimage[0.29\linewidth]{german-infantry-back} \\
  \footnotesize Front: German infantry division & \footnotesize Back \\
  \addlinespace[5pt]
  \counterimage[0.29\linewidth]{partisan-group} &
  \counterimage[0.29\linewidth]{partisan-brigade} \\
  \footnotesize Front: Partisan group & \footnotesize Back: Partisan brigade
\end{tabular}
\end{center}

The designation appears at the top, the unit-size symbol above the NATO unit
symbol, and Combat Strength at the bottom.
...
\begin{center}
\begin{tabular}{@{}c c c@{}}
  \counterimage[0.22\linewidth]{german-panzer} &
  \counterimage[0.22\linewidth]{german-cavalry} &
  \counterimage[0.22\linewidth]{german-parachute} \\
  \scriptsize Panzer & \scriptsize Cavalry & \scriptsize Parachute \\
  \addlinespace[4pt]
  \counterimage[0.22\linewidth]{tito-unidentified} &
  \counterimage[0.22\linewidth]{tito-identified} &
  \counterimage[0.22\linewidth]{victory-points} \\
  \scriptsize Tito & \scriptsize Tito identified & \scriptsize Victory Points
\end{tabular}
\end{center}
