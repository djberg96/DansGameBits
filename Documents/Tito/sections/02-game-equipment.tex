...
\begin{tabular}{@{}>{\centering\arraybackslash}m{0.46\linewidth}@{\hspace{0.02\linewidth}}>{\centering\arraybackslash}m{0.46\linewidth}@{}}
  ...
  \counterimage[0.43\linewidth]{german-infantry-back} \\
  \scriptsize German front & \scriptsize German back \\
  \addlinespace[5pt]
  \counterimage[0.43\linewidth]{partisan-group} &
  \counterimage[0.43\linewidth]{partisan-brigade} \\
  \scriptsize Partisan front & \scriptsize Partisan back
\end{tabular}
\end{center}
