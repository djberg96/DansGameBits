...
\vspace{3pt}
\begin{tabular}{@{}c c c@{}}
  \counterimage[0.20\linewidth]{victory-points} &
  \counterimage[0.20\linewidth]{victory-points-negative} &
  \counterimage[0.20\linewidth]{allied-progress} \\
  \scriptsize \shortstack{Victory Points\\(+)} &
  \scriptsize \shortstack{Victory Points\\(-)} &
  \scriptsize \shortstack{Allied\\Progress} \\
  \addlinespace[4pt]
  \counterimage[0.20\linewidth]{game-turn} &
  \counterimage[0.20\linewidth]{drought-turn} &
  \counterimage[0.20\linewidth]{anti-guerrilla-operations} \\
  \scriptsize \shortstack{Game\\Turn} &
  \scriptsize \shortstack{Drought\\Turn} &
  \scriptsize \shortstack{Anti-Guerrilla\\Operations}
\end{tabular}
\end{center}
