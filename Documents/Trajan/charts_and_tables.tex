...

{
  ...
  \resizebox{\textwidth}{!}{
    \begin{tabular}{|lcccccc|}
      \hline & & & & & &\\[-2.0ex]
      \hspace{-1.5em}\textbf{MARCH TABLE} & & & & & &\\
      \hspace{-1.5em}March Type & \multicolumn{5}{c}{Die Roll} &\\
      & \textbf{1} & \textbf{2} & \textbf{3} & \textbf{4} & \textbf{5} & \textbf{6}\\
      \hspace{-1.5em}Road/Trade Route & N & M/W & M2/A & M/F & M2/F & M2/W\\
      \rowcolor{BabyBlue}\hspace{-1.5em}Cross Country & N & M/S/W & M/S/A & M/A & M/F & M1/W\\
      \hspace{-1.5em}River & N & R/W & R/A & R/F & R/S & R/W\\
      \rowcolor{BabyBlue}\hspace{-1.5em}Sea & N & O/W & O/X & O/A & O/F & O/W\\
      \hline
    \end{tabular}
  }
}
