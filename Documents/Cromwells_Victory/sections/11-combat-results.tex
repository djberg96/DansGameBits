...
\centering
{\sffamily\bfseries\small Leader Examples}\par\vspace{4pt}
\includegraphics[width=.68in]{images/rulebook-counters/rupert-leader.pdf}
\hspace{.36in}
\includegraphics[width=.68in]{images/rulebook-counters/leven-leader.pdf}
\end{tcolorbox}
