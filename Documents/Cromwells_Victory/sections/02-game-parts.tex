...
\begin{tikzpicture}[x=1in,y=1in]
  ...
  \draw[piece lead] (ucombat.east) -- (1.08,.31);
  ...
  \draw[piece lead] (umove.west) -- (1.25,.31);
...
\begin{tikzpicture}[x=1in,y=1in]
  ...
  \draw[piece lead] (lcommand.east) -- (1.11,.31);
  \node[piece label,anchor=west] (lmove) at (1.70,.15) {Movement\\Allowance};
  \draw[piece lead] (lmove.west) -- (1.22,.31);
...
\begin{tikzpicture}[x=1in,y=1in]
  ...
  \node[piece label] at (1.16,1.12) {Front (ready)};
  \node[piece label] at (2.66,1.12) {Back (captured)};
  \node[piece label,anchor=east] (abtype) at (2.24,.28) {Artillery\\Type Symbol};
  \draw[piece lead] (abtype.east) -- (2.64,.48);
  \node[piece label,anchor=south] (abcaptured) at (2.66,.86) {Indicates\\Captured};
  \draw[piece lead] (abcaptured.south) -- (2.66,.63);
\end{tikzpicture}
\endgroup
\end{tcolorbox}
