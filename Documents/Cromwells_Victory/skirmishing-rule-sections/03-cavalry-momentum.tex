...
adjacent hex vacated by a defending unit in that combat. This includes a hex
vacated because all its defenders were eliminated, whether they were Foot or
Horse, as well as a hex vacated by cavalry recoil. If more than one defending
hex was vacated, one eligible Heavy Horse unit may advance into each vacated
hex. No unit may advance more than once per Combat Phase.
...
\begin{enumerate}[leftmargin=1.3em,itemsep=.12em,topsep=.1em]
  ...
  \item Advance eligible Heavy Horse into hexes vacated by elimination or
        recoil.
...
destruction. Foot does not recoil, but Heavy Horse may advance after eliminating
it. Limiting the follow-up to Heavy Horse preserves the shock role of that arm.
The prohibition on another attack keeps the result to a local breakthrough
rather than allowing cavalry to roll up several units in one Combat Phase.
