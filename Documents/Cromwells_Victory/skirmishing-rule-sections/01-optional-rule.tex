...
Only an \textbf{ordered Foot unit} belonging to the active player may initiate a
skirmish. Its target must be an ordered enemy unit. Leaders, artillery pieces,
and trains may neither initiate nor be the target of a skirmish.

A unit in a close, train, or woods hex cannot be the target of a skirmish.
...
The player identifies the target and places a \textbf{Skirmish---Return} marker
in the hex the Foot unit just vacated. That hex is reserved; no other piece may
enter it before the skirmish is resolved. The skirmishing unit's movement ends
immediately. The active player then completes all other ordinary movement before
rolling any skirmish dice.
...
The idea is to show commanded musketeers feeling out the enemy before the main
fight. Because the dice come after movement, any Horse waiting to exploit a
disruption must be committed first. Most exchanges will do nothing; occasionally
one will open a useful opportunity. That is about as much weight as this small
rule should carry.
\end{multicols}
