...
\newcommand{\americancommanddiagram}{%
  \begin{figure}[htbp]
    ...
    \begin{tikzpicture}[x=1cm,y=1cm,font=\scriptsize,>=latex,
      ...
      \node[align=left,anchor=west,text width=7.1cm] at (-3.35,0.12) {The American player spends 4 activation points and uses Washington's 6 command span. 13 leaders have been activated.};
      ...
      \node[inner sep=0] (hitchcockcommand) at (-2.9,-4.0) {\countergraphic{american-leader-hitchcock}{1.15cm}};
      \node[inner sep=0] (sargentcommand) at (-1.15,-4.0) {\countergraphic{american-leader-sargent}{1.15cm}};
      \node[inner sep=0] (mcdougallcommand) at (0.60,-4.0) {\countergraphic{american-leader-mcdougall}{1.15cm}};
      \node[inner sep=0] (mercercommand) at (2.35,-4.0) {\countergraphic{american-leader-mercer}{1.15cm}};
      \node[anchor=west] at (-2.9,-3.02) {\textbf{Sullivan activates 4 leaders} for 4 CS};
      \draw[commandarrow] (sullivancommand.south) -- (-2.9,-3.32);
      \draw[commandline] (-2.9,-3.32) -- (2.35,-3.32);
      \draw[commandarrow] (-2.9,-3.32) -- (hitchcockcommand.north);
      \draw[commandarrow] (-1.15,-3.32) -- (sargentcommand.north);
      \draw[commandarrow] (0.60,-3.32) -- (mcdougallcommand.north);
      \draw[commandarrow] (2.35,-3.32) -- (mercercommand.north);

      \node[inner sep=0] (greenecommand) at (-2.9,-5.8) {\countergraphic{american-leader-greene}{1.15cm}};
      \node[anchor=west] at (-2.15,-5.8) {\textbf{Washington activates Greene} for 3 CS};
      \draw[commandarrow] (-5.2,-2.0) -- (-5.2,-5.8) -- (greenecommand.west);
      \node[rotate=90,font=\footnotesize] at (-5.55,-3.9) {Activates};

      \node[inner sep=0] (cadwaladercommand) at (-2.9,-7.8) {\countergraphic{american-leader-cadwalader}{1.15cm}};
      \node[inner sep=0] (mifflincommand) at (-1.15,-7.8) {\countergraphic{american-leader-mifflin}{1.15cm}};
      \node[inner sep=0] (stirlingcommand) at (0.60,-7.8) {\countergraphic{american-leader-lord-stirling}{1.15cm}};
      \node[inner sep=0] (fermoycommand) at (2.35,-7.8) {\countergraphic{american-leader-fermoy}{1.15cm}};
      \node[anchor=west] at (-2.9,-6.82) {\textbf{Greene activates 4 leaders} for 5 CS};
      \draw[commandarrow] (greenecommand.south) -- (-2.9,-7.12);
      \draw[commandline] (-2.9,-7.12) -- (2.35,-7.12);
      \draw[commandarrow] (-2.9,-7.12) -- (cadwaladercommand.north);
      \draw[commandarrow] (-1.15,-7.12) -- (mifflincommand.north);
      \draw[commandarrow] (0.60,-7.12) -- (stirlingcommand.north);
      \draw[commandarrow] (2.35,-7.12) -- (fermoycommand.north);

      \node[inner sep=0] (dickinsoncommand) at (-2.9,-10.0) {\countergraphic{american-leader-dickinson}{1.15cm}};
      \node[inner sep=0] (detachmentcommand) at (-1.15,-10.0) {\countergraphic{american-detachment-4}{1.15cm}};
      \node[anchor=west] at (-2.9,-8.82) {\textbf{Cadwalader activates 2 leaders} for 2 CS};
      \draw[commandarrow] (cadwaladercommand.south) -- (-2.9,-9.32);
      \draw[commandline] (-2.9,-9.32) -- (-1.15,-9.32);
      \draw[commandarrow] (-2.9,-9.32) -- (dickinsoncommand.north);
      \draw[commandarrow] (-1.15,-9.32) -- (detachmentcommand.north);

      \node[align=left,anchor=west,font=\footnotesize] at (0.2,-10.35) {AP = Activation Point Cost\\CS = Command Span Used};
    \end{tikzpicture}
