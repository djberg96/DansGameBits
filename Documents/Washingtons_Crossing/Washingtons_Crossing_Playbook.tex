...
\begin{playchart}[0.72\linewidth]
  ...
  \begin{tabular}{lccc}
    \toprule
    \rowcolor{black!10}
    \textbf{Modified Die Roll\,*} & \textbf{2--4} & \textbf{5--6} & \textbf{7--8} \\
    \midrule
    $-6$ or less & 0 MP & 0 MP & 0 MP \\
    $-5$ to $-3$ & 3 MP & 4 MP & 5 MP \\
    $-2$ to 0 & 4 MP & 5 MP & 6 MP \\
    1 to 3 & 5 MP & 6 MP & 7 MP \\
    4 to 6 & 6 MP & 7 MP & 8 MP \\
    7 to 9 & 7 MP & 8 MP & 9 MP \\
    10 or more & 8 MP & 9 MP & 10 MP \\
    \bottomrule
  \end{tabular}
  \chartnote{\textit{* Movement Matrix Die Roll Modifiers}\par\smallskip
  \begin{tabularx}{\linewidth}{rY rY}
    +4 & Night Move (American) & $-1$ & Disordered \\
    +2 & British Vanguard & $-1$ & Fatigue 1 \\
    $-2$ & All other British & $-2$ & Fatigue 2 \\
    $-1$ & Snow & $-3$ & Fatigue 3 \\
    $-2$ & Rain & $-4$ & Fatigue 4 \\
    +1 & Freeze & & \\
  \end{tabularx}}
...
\begin{playchart}[0.72\linewidth]
  ...
  \begin{tabularx}{\linewidth}{lY}
    ...
    \midrule
    0--2 & Continues \\
    3 & Continues if Freeze, otherwise New Weather \\
    4--5 & Continues if Rain, otherwise New Weather \\
    6--8 & Continues if Snow, otherwise New Weather \\
    9 & New Weather (see table below) \\
    \bottomrule
  \end{tabularx}
...
\begin{playchart}[0.68\linewidth]
  ...
  \begin{tabularx}{\linewidth}{lY}
    ...
    \rowcolor{black!10}\textbf{Die Roll} & \textbf{Result} \\
    \midrule
    0--2 & Raid --- consult Raid Leader Table \\
    3--6 & No effect \\
    \bottomrule
  \end{tabularx}
  \medskip
...
\begin{playchart}[0.75\linewidth]
  ...
  \begin{tabularx}{\linewidth}{lY}
    ...
    \rowcolor{black!10}\textbf{Die Roll} & \textbf{Result} \\
    \midrule
    0 & Attacker loses 20 troops \\
    1--2 & Attacker loses 10 troops \\
    3 & No effect \\
    4--5 & Defender loses 10 troops and takes 1 Fatigue \\
    6 & Defender loses 20 troops and takes 1 Fatigue \\
    7 & Defender loses 20 troops and the British player loses 1 Activation Point \\
    8 & Defender loses 30 troops and takes 1 Fatigue \\
    9 & Defender loses 30 troops and the British player loses 1 Activation Point \\
    \bottomrule
  \end{tabularx}
...
\begin{playchart}[0.72\linewidth]
  ...
  \begin{tabular}{lcc}
    \toprule
    \rowcolor{black!10}\textbf{Modified Die Roll\,*} & \textbf{CRT Modifier} & \textbf{Attacker \%} \\
    \midrule
    $-4$ or less & $-6$ & +15 \\
    $-3$ & $-5$ & +10 \\
    $-2$ & $-4$ & +10 \\
