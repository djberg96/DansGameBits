...
\playimage{Introduction_files/LeaderDisplay_w7rE.JPG}{Leader display.}
...
\playimage{Introduction_files/LeaderCounter_w7rE.JPG}{Leader counter.}
...
\playimage{Introduction_files/Movement_Chart_w7rE.JPG}{Movement Matrix chart.}
...
\playimage{WC_GameSetup_files/DurhamBoatSetup_hY4C.JPG}{Durham Boat setup marker.}
...
\playimage{WC_turn1_files/SequenceOfPlay_JvYc.JPG}{Sequence of play.}
...
\playimage{WC_turn1_files/ContinuingWeather_JvYc.JPG}{Continuing Weather table.}

If the weather does not continue, players consult the New Weather Table to check what the current turn's weather will be.

\playimage{WC_turn1_files/NewWeather_JvYc.JPG}{New Weather table.}
...
\playimage{WC_turn1_files/RaidTable1_JvYc.JPG}{Raid Table.}
\playimage{WC_turn1_files/RaidTable2_JvYc.JPG}{Raid Leader Table.}
...
\playimage{WC_Turn3_files/SurpriseTable_SpxH.JPG}{Surprise table.}
...
\playimage{WC_Turn5_files/FairWeatherSymbol_FQ5g.JPG}{Fair weather symbol.}
...
\playimage{WC_Turn6_files/FairWeatherSymbol_Cvqs.JPG}{Fair weather symbol.}
