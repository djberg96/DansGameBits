...
\newcommand{\americancommanddiagram}{%
  \begin{figure}[htbp]
    ...
    \begin{tikzpicture}[x=1cm,y=1cm,font=\scriptsize,>=latex,
      ...
      \node[anchor=west] at (-2.15,-2.0) {\textbf{Washington activates Sullivan} for 3 CS};
      ...
      \node[anchor=west] at (-2.9,-3.12) {\textbf{Sullivan activates 4 leaders} for 4 CS};
      ...
      \node[anchor=west] at (-2.15,-6.5) {\textbf{Washington activates Greene} for 3 CS};
      ...
      \node[anchor=west] at (-2.9,-7.52) {\textbf{Greene activates 4 leaders} for 5 CS};
      ...
      \node[anchor=west] at (-2.9,-9.92) {\textbf{Cadwalader activates 2 leaders} for 2 CS};
