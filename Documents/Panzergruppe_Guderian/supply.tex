...
\nobreak\\\\
\textcolor{blue}{NOTE: This case does apply to Case 11.11 but does not apply to Case 11.12, i.e., when using the twenty Movement Point routine to trace supply, the cost to cross the river is paid regardless of the presence of roads.}
