...
\begin{strip}
  ...
  \begin{tabular}{|llll|}
    ...
    \hline & & &\\[-2.0ex]
    \textbf{Clear Hex} & 1 MP & No Effect & No effect\\
    \hline & & &\\[-2.0ex]
    \textbf{Forest Hex} & Inf. (not Mot.): 1 MP & Defender & No Effect\\
    & All others: 2 MP & doubled in hex &\\
    \hline & & &\\[-2.0ex]
    \textbf{River Hexside} & Germans: add 2 MP to cross & Defender & No Effect\\
    & Soviets: add 1 MP to cross & doubled* &\\
    \hline & & &\\[-2.0ex]
    \textbf{Major City} & 1 MP & Defender & No effect\\
    & & doubled in hex &\\
    \hline & & &\\[-2.0ex]
    \textbf{Minor City} & 1 MP & No Effect & No effect\\
    \hline & & &\\[-2.0ex]
    \textbf{Swamp Hex} & 2 MP & No Effect & May trace into,\\
    & & & but not through.\\
    \hline & & &\\[-2.0ex]
    \textbf{Lake Hexside} & May not cross & Not Allowed & May not trace\\
    & & & through\\
    \hline & & &\\[-2.0ex]
    \textbf{Road Hex} (see Case 11.13)& Inf. (not Mot.) \& Cav: 1 MP & No effect & Germans must\\
    & All others: 1/2 MP & & trace on roads.\\
    \hline
    \textbf{Railroad Hex} & Depends on other terrain & No effect & No effect\\
    & (see Case 6.3) & &\\
    \hline
  \end{tabular}
  }
  ...
  *If attacked solely across river.
  ...
  \begin{tabular}{|lccccccccccccr|}
    \hline & & & & & & & & & & & & &\\[-2.0ex]
    \multicolumn{5}{|l}{\textbf{[9.5] COMBAT RESULTS TABLE}} & & & & & & & & &\\
...
\par
\textbf{A1, A2 (or D1, D2)} = The Attacker (or Defender) may choose to lose the number of steps, or retreat the entire stack the number of hexes indicated (one or two). \textcolor{blue}{Units in a stack may be retreated to different hexes.} Opposing Player may advance along Path of Retreat.
\par
\textbf{Eng} = Engaged. Each side must take one step loss and remain in place. No retreat or advance after combat is possible.
\par
In a split result (e.g., D1/A1), Defender takes losses or retreats first, then Attacker must decide to retreat or lose one step; if step loss is taken, the units may advance after combat.
\par
