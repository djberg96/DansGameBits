...
\noindent COMMENTARY:\par
\noindent Control of the skies by the Luftwaffe enabled the Germans to restrict, to some extent, troop movements by the Soviets along major arteries. The Soviets, in return, had a feeble air force and a minimal rear-guard partisan effort.\par
\medskip
\noindent CASES:\par
\endgroup
...
\subsubsection{} If an Air Interdiction Marker is placed on a Railroad hex, it costs each unit \textbf{four} of the RR Bonus Movement Points to move through that hex, if they are using Rail Movement. Otherwise, it \textbf{adds one} Movement Point to the cost of other terrain in the hex.
