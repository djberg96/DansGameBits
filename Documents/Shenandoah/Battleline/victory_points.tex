...
\textit{For instance, a score of 123 would be indicated by placing one counter in the "100" box, one counter in the "20" box and one counter in the "3" box.}
...
\begin{enumerate}
  ...
  \textit{For instance, if the Confederates had 5 Resource Factors to the Union's 7 Resource Factors, the Confederates would get two Victory Points.}
  ...
  \textit{For instance, if the Union Player exited 1 Infantry Combat Factors and one Cavalry Combat Factor (11 x 4 = 44 + 6 = 50 Victory Points), he would reduce his Resource Factor by "one".}
