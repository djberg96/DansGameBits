...
\begin{enumerate}
  ...
  \textit{For example, if the Union Player exited 1 Infantry Combat Factors and one Cavalry Combat Factor (11 x 4 = 44 + 6 = 50 Victory Points), he would reduce his Resource Factor by "one".}
