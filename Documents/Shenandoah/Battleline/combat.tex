...
\begin{enumerate}
  ...
  \item The defender, ignoring for the moment the effects of the attacker's Combat, examines the DEFENDER'S COMBAT TABLES, cross-gridding the number of Combat Factors he has with his present Formation and the terrain of the hex he is in (NOTE: If some of the defender's units are in Column Formation, all are treated being in Column Formation for purposes of using this Table).
