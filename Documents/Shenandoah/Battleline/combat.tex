...
\begin{enumerate}
  ...
  \item It is now the second Round of Combat. During his segment of the Round, the Phasing Player is now allowed to exercise any of these options exercised by his opponent during the previous Round of Combat, a), b) or c). Note that he can only do so if he has enough Movement Allowance Factors to do so, otherwise he can participate in no further Rounds of Combat. Also note that if he exercises option c) that this expens Movement Allowance Factors for Combat.
...
\begin{enumerate}
  \item The Attacker examines the ATTACKER'S COMBAT TABLES, crossgridding the number of Combat Factors he is attacking with his present Formation (NOTE: If some of the attacker's units are in Column Formation, all of the units are assumed to be in Column Formation for purposes of using this Table). The number found is the attacker's Basic Combat Table Number.
