...
\begin{enumerate}
  ...
  \item In hexes where there are several types of terrain features, units in Column Formation may use the most advantageous movement rates. Units in Battle Formation always use the least advantageous movement rates (For instance, a unit in Battle Formation in a hex with both clear and slope terrain in it will move at the cost in Movement Allowance Factors for the slope terrain, not the clear terrain).
...
\begin{enumerate}
  ...
  \item In hexes where there are several types of terrain featurs, the highest cost is the one used (For instance, a unit in a hex that contains both clear and slope terrain will use up the number of Movement Allowance Factors appropriate for slope terrain when Stacking and Unstacking units).
...
\begin{enumerate}
  ...
  \item In hexes where there are several types of terrain features, the highest cost is the one used (For instance, a unit in a hex containing both clear and slope terrain will use up the number of Movement Allowance Factors appropriate for slope terrain when changing Formation).
