...
\subsection[{\texorpdfstring{\protect\shortstack[l]{9.5 Reaction from Enemy\\\hspace*{1.55em}-Occupied Hexes}}{9.5 Reaction from Enemy-Occupied Hexes}}]{9.5 Reaction from Enemy-Occupied Hexes}
